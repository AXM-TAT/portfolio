...
export default function Footer() {
  return (
    <footer className="bg-black/80 border-t border-gray-800/50 py-12">
        ...
        <div className="text-center">
          ...
          >
            <div className="logo-container relative inline-block">
              <span className="premium-logo logo-glow font-montserrat tracking-[0.15em]">
                AXOM
              </span>
              <div className="absolute -right-3 top-1 logo-dot"></div>
            </div>
          </Link>
          <p className="text-gray-400 max-w-md mx-auto mb-8">
            Crafting innovative digital experiences with modern technologies and AI integration.
          </p>
          ...
          <p className="mt-8 text-gray-500 text-sm">
            © {new Date().getFullYear()} AXOM. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
